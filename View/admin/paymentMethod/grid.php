...
<section>
    ...
    <h2>View Payment Method Records
        <a onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('edit','admin_paymentMethod'); ?>').resetParams().load();" class="btn btn-primary" style="float:right;">Add New Record</a>
    </h2>
    <hr>
        ...
        <tbody>
            ...
            <?php foreach($paymentMethods as $key => $value): ?>
                <tr>
                    ...
                    <td>
                        <a onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('edit',null,['id'=>$value->paymentMethodId]);?>').resetParams().load();" style="color:green">
                        <i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp
                        <a onclick="object.setUrl('<?php echo $this->getUrl()->getUrl('delete',null,['id'=>$value->paymentMethodId]);?>').resetParams().load();" style="color:red" >
